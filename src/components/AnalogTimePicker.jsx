          ...
          >
            <defs>
              {/* Arrowhead for Hour Hand */}
                                          <marker id="hour-arrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="3" markerHeight="3" orient="auto-start-reverse">
            ...
            <line
              x1="50"
              y1="50"
                            x2={50 + 27 * Math.cos(hourAngle * Math.PI / 180)}
              y2={50 + 27 * Math.sin(hourAngle * Math.PI / 180)}
